              ...
              <div className="w-full lg:w-1/2">
                <div className="xb-hero pt-[40px] md:pt-[93px]">
                  ...
                  <div className="xb-btn mt-[30px] md:mt-[50px] animate-fadeInUp" 
                       ...
                       data-wow-duration="600ms">
                    <a href="contact.html" className="inline-flex items-center px-5 py-2 md:px-6 md:py-3 text-white transition-colors duration-300 bg-blue-800 border-2 border-blue-800 rounded-full hover:bg-white hover:text-blue-800">
                      <span className="mr-2 text-[16px] md:text-[18px]">Book a Discover Call</span>
                      <div className="flex items-center justify-center w-5 h-5 md:w-6 md:h-6 bg-white rounded-full group-hover:bg-blue-800">
